...
<br>
<div>
    <p style="white-space: pre-wrap; tab-size: 4;">
...
<div>
    <div align=center>
        <span style="font-size: 20px; text-decoration: underline">Watch my video code Review on YouTube <a href="https://youtu.be/rXyeCxc2VNY?si=0Liqg5aZxrjuoOY4" alt="Code Review Vide - YouTube" target="_blank">HERE!</a></span>
    </div>
    <br>
    <p style="white-space: pre-wrap; tab-size: 4;">
    ...
    <div>
        <div align="center"><a href="https://github.com/NicholasShaner/CS499_CompSciCapstone/tree/main/petBAG_original" alt="link to petBAG original file gitHub" target="_blank">petBAG Application Pre-Enhancement</a></div>
        <div align="center"><br>
            <img src="./petBAGPre.png" width="500">
        </div>
        <p style="white-space: pre-wrap; tab-size: 4;">
...
<div>
    <div>    
        <div align="center"><a href="https://github.com/NicholasShaner/CS499_CompSciCapstone/blob/main/inventoryApp.zip" alt="Link to Final inventoryApp ZIP on gitHub" target="_blank">InventoryApplication Post-Enhancement</a></div>
        <p style="white-space: pre-wrap; tab-size: 4;">
    ...
    <div>
        <div align="center"><a href="https://github.com/NicholasShaner/CS499_CompSciCapstone/tree/main/petBAG" alt="link to petBAG final enhancement gitHub" target="_blank">petBAG Application Post-Enhancement</a></div>
        <div align="center"><br>
            <img src="./petBAGSnip.png"/>
        </div>
        <p style="white-space: pre-wrap; tab-size: 4;">
...
<div>
    <div>    
        <div align="center"><a href="https://github.com/NicholasShaner/CS499_CompSciCapstone/blob/main/inventoryApp.zip" alt="Link to Final inventoryApp ZIP on gitHub" target="_blank">InventoryApplication Post-Enhancement</a></div>
        <div align="center"><br>
            <img src="./inventoryApp_DBView.png"/>
        </div>
        <p style="white-space: pre-wrap; tab-size: 4;">
            Focusing on databases, I chose to again use my inventoryApplication which was created during CS360 – Mobile Application Development which was completed C-2 of 2026. I felt including this artifact for my ePortfolio was important because the application is relevant in today’s development field. Additionally, though functioning appropriately, the program left room for necessary enhancements to improve the accessibility, functionality, and security of the program. I feel the program does a very good job at illustrating my skills in Java development and the use of relevant frameworks. The artifact also displays skills learned in relational database management and effective access mechanisms by utilizing SQLite to create, store, and access various databases. The structure of the program allows me to demonstrate my understanding of the importance of object-oriented programming, the efficiencies it creates, as well as the stability and security it inherits. To prove the skills learned the enhancements I have made to the program include cleaning up my class methods and structures to ensure that database access is secure and efficient enough to handle more complex database management and sort functionality. To enhance the security of the program, I expanded my program to handle password hashing using PBKDF2 and SHA-256 hashing algorithms utilizing 16 bit salts. Additionally, I was able to successfull instantiate simple role-based access handled through login and appropriately passing intent extras through page navigation. This RBAC gave me the ability to provide each user with custom appearences throughout the program by controlling page and inner page links that are displayed dependant on access level assigned. This additional program security is where I ran into my biggest challenges as these methods were well outside the scope of the original coursework. The most valuable resource I found to learn these tasks was the Android Developers guides which provided very clear instruction, directive, and example based learning. 
        </p>
    </div>
</div>
<hr>
...
<div align=center>
    ...
    <br><br>
    <span><p stle="text-decoration: italics">CS-499 Computer Science Capstone</p></span>
    <span><p stle="text-decoration: italics">Nicholas Shaner</p></span>
    <span><p stle="text-decoration: italics">Southern New Hampshire University</p></span>
    <span><p stle="text-decoration: italics">2026 C-3 (May-June)</p></span>
    <span><p style="font-size: 13px">Check Out My <a href="https://github.com/NicholasShaner/" target="_blank">Github</a></p></span>
    <span><p style="font-size: 13px">Connect With Me On <a href="https://www.linkedin.com/in/nicholas-shaner/" target="_blank">LinkedIn</a></p></span>
</div>
